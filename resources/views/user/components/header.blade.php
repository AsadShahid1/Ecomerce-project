                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="index.html" class="logo">
                            <img src="{{asset('assets/images/demos/demo-13/logo.png')}}" alt="Molla Logo" width="105"
                                height="25">
                        </a>
                    </div><!-- End .header-left -->
                            ...
                            {{-- <ul class=" navbar-right"> --}}
                                {{-- <li class="nav-item dropdown open"> --}}
                                    <div class="dropdown ml-4">
                                        <a id="my-dropdown" class="dropdown-toggle"
                                            data-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false">{{Auth::user()->first_name}}</a>
